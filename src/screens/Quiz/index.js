...
function LoadingWidget({ externalTitle }) {
...
export default function QuizPage({ externalQuestions, externalBg }) {
  const [screenState, setScreenState] = React.useState(screenStates.LOAGING);
  ...
  return (
    <QuizBackground backgroundImage={bg}>
      <QuizContainer>
        ...
        {screenState === screenStates.LOAGING && <LoadingWidget />}
